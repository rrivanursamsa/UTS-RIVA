    ...
    <div class="card mt-4">
        <div class="card-header bg-warning">
           ...
           <form method="POST">
                ...
                <tr>
                    <td>Masukan Besar Alas</td>
                    <td><input type='number'  name="alas" min="1" max="100000000000000000000"></td>
                </tr>
                </div>
                <div class="form-group mt-4">
                <tr>
                    <td>Masukan Besar Tinggi</td>
                    <td><input type='number' name="tinggi" min="1" max="1000000000000000000000"></td>
                </tr>
                </div>
...
if(isset($_POST['simpan'])){
    ...
    echo "Besar Alas (cm) : $a <br>";
    echo "Besar Tinggi (cm) : $b <br>";
    echo "Rumus Menghitung Luas segitiga : alas x tinggi <br>";
