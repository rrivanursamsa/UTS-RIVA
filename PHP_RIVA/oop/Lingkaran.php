        ...
        <div class="card-header bg-warning">
           ...
           <form method="POST">
                ...
                <tr>
                    ...
                    <td><input type='number'  name="jari-jari" min="1" max="100000000000000000000"></td>
                </tr>
                </div>
                <div class="form-group mt-4">
                <tr>
...
if(isset($_POST['simpan'])){
    ...
    echo "Phi : 3.14 <br>";
    echo "jari-jari Lingkaran: $a <br>";
    echo "jari-jari Lingkaran: $b <br>";
    echo "Rumus Menghitung Luas lingkaran : jari-jari x jari-jari <br>";
